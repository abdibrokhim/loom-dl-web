...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-full text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-[var(--violet)] hover:bg-[var(--ring)] text-[var(--text-a)] shadow",
        destructive: "bg-[var(--ring)] hover:bg-[var(--violet)] text-[var(--text-a)] shadow",
        outline: "bg-white hover:text-white px-2 py-1 sm:px-2 sm:py-2 rounded-md sm:rounded-lg bg-opacity-50 mr-2 border border-[#44403C]/90 text-xs sm:text-sm w-auto whitespace-nowrap flex-shrink-0 cursor-pointer hover:bg-opacity-90 hover:bg-[#44403C]/90 hover:border-[#44403C]/90 active:bg-opacity-70 transition-all duration-100 select-none",
